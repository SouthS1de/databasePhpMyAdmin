...
<body>
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-md-10">
				<h3 class="text-center text-dark mt-2">Таблица категорий товаров</h3>
				<hr>
	...
	<div class="row mt-2 ml-1">
		<div class="col-md-4">
			<h3 class="text-center text-info">Введите данные категории товара:</h3>
			<form action="operations/actionCategories.php" method="post" enctype="multipart/form-data">
				<div class="form-group">
					<input type="text" name="name" value="<?= $name ?>" class="form-control" placeholder="Введите название товара" required>
				</div>
				<div class="form-group">
					<input type="text" name="note" value="<?= $node ?>" class="form-control" placeholder="Введите примечание" required>
				</div>
				<div class="form-group">
			    		...
			    		<?php 
							...
							if($result)
							{
								...
								for($i = 0; $i < $rows; ++$i)
								{
									...
									<a href="operations/actionCategories.php?delete=<?= $row[0]; ?>" onclick="return confirm('Вы действительно хотите удалить эту запись?');" class="badge badge-danger p-2">Удалить</a>
									<?echo "</td>";
									echo"<tr>";
									echo"<tr>";
								}
